...
main = do
    ...
    imageSurface <- loadBitmap "./assets/stretch.bmp" >>= either throwSDLError return
    ...
    repeatUntilComplete $ draw stretchedSurface stretchRect >> handle pollEvent
